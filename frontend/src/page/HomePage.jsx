...
const handleRecommendedproblems = useCallback(
  ...
  return (
    <div className="min-h-screen flex flex-row-reverse gap-6 ">
      ...
      <div className="flex flex-col items-center ">
        ...
        <div className="flex flex-row min-h-[400px] min-w-[400px] ">
          {isProblemsLoading ? (
            <div className="flex  flex-1/2 items-center justify-center text-gray-500 mr-2 text-sm text-center h-screen">
              <p> Loading </p>
            ...
            <aside className="w-64 bg-primary/20 p-6  h-full shadow-md overflow-y-auto">
              <div className="flex flex-col rounded-lg shadow-md bg-primary/30 items-center ">
                ...
                <div
                  className="radial-progress w-22 h-22 shadow-lg text-xl font-bold text-primary bg-white p-4 rounded-full border-4 border-gray-200"
                  style={{
                    "--value": Math.round(
